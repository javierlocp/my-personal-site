...
export default function BackButton() {
  ...
  return (
    <button onClick={() => navigate(-1)} className="cursor-pointer rounded-full bg-neutral-800 p-2 text-gray-50 transition-all duration-100 hover:bg-gray-500 active:scale-80">
