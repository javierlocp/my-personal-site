  ...
  return (
    <>
      <div className="intro mb-4 flex flex-col gap-4">
        <h1 className="text-pretty">I'm a product designer with 13+ years of experience crafting mobile and web products for start-ups and large orgs.</h1>
        <p className="text-pretty">
          ...
          <ExternalLink href="https://brankas.com/">Brankas</ExternalLink>, <ExternalLink href="https://says.com/">Says</ExternalLink> and Yield App (Sunsetted 🌻).
        </p>
      </div>
      <BookCall />
      <ProjectPreview />
