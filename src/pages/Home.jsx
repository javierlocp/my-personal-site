  ...
  return (
    <>
      <div className="intro mb-4 flex flex-col gap-4">
        <h1 className="text-pretty">I'm a product design lead with over a decade of experience crafting mobile and web products for startups and large organizations.</h1>
